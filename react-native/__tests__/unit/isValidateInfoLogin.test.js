...
describe('isValidateInfo (login) isolated', () => {
  beforeEach(() => {
    showToast.mockClear()
  ...
  it('returns false if any field is missing', () => {
    const result = isValidateInfo('', 'test@example.com', 'Pass123')
  ...
  it('returns false for invalid email', () => {
    ...
    const result = isValidateInfo('User', 'invalid-email', 'Pass123')
    expect(result).toBe(false)
  ...
  it('returns false for invalid password', () => {
    ...
    const result = isValidateInfo('User', 'test@example.com', '123')
    expect(result).toBe(false)
  ...
  it('returns true for valid input', () => {
    ...
    const result = isValidateInfo('User', 'test@example.com', 'Pass123')
